...
class AdminReportActivityController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->col[] = array("label" => "Customer Saldo", "name" => "sisa_saldo","callback"=>function($row){
            return number_format($row->sisa_saldo,2,',','.');
        });
