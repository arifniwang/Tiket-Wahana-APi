    ...
    public function getIndex()
    {
        ...
        foreach ($data['result'] as $row) {
            ...
            foreach ($columns_table as $col) {
                ...
                if (isset($col['image'])) {
                    if ($value == '') {
                        $value = "<a  data-lightbox='roadtrip' rel='group_{{$table}}' title='$label: $title' href='".asset('vendor/crudbooster/avatar.png')."'><img width='40px' height='40px' src='".asset('vendor/crudbooster/avatar.png')."'/></a>";
                    } else {
